...
7.  **About Us** (at `/about`): An about page showcasing NovaPath's values (Educators First, Real Solutions, AI Literacy), featuring a highlighted EdWeek article about founder Dan Whitlock (August 2025), an upcoming Charter Conference 2026 event section (February 24, 2026), and embedded LinkedIn posts in a "Recent Updates" section. The EdWeek article "Want Teachers to Learn How to Use AI for Instruction? Let Them Design the Tools" profiles Dan's work at Navigator Schools. The upcoming event showcases Dan's presentation "Designing the Future Before It Designs Us: AI at Navigator Schools" at the Charter Schools Conference in Long Beach, CA.
